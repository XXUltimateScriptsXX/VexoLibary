...
-- Helper function to handle URLs vs IDs
...
function Library:CreateWindow(Config)
	...
	gui.Name = "CustomLib_" .. HttpService:GenerateGUID(false)
	...
	crownImg.Image = fetchAsset(IconURL) -- DOWNLOADS URL IF NEEDED
	...
	function Tabs:CreateTab(name)
		...
		function Modules:CreateButton(config)
			...
			icon.Image = fetchAsset(config.Icon) -- SUPPORTS URL
			icon.Parent = frame
